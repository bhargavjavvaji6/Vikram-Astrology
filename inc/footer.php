        ...
        <div class="as_newsletter_wrapper as_padderBottom60">
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                    ...
                    <p>Get Your Daily Horoscope, Love-scope, and<br> Tarot Insights Directly In Your Inbox</p>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="as_footer_widget">
                        ...
                        <p>Your trusted destination for authentic astrology readings, gemstone consultations, and
                            spiritual guidance — helping you navigate life's biggest questions with clarity and
                            confidence.</p>
                    ...
                    <div class="as_footer_widget">
                        ...
                        <ul class="as_contact_list">
                            <li>
                                ...
                                <p>Gotham Hall, 1356 Broadway Square,
